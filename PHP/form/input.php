...
require 'validation.php';
  ...
  if(!empty($_POST)){
    echo '<pre>';
    var_dump($_POST); //スーパーグローバル変数　連想配列
    echo '</pre>';
  }
      ...
      <div class="col-md-6">
        <form method="POST" action="input.php">
          ...
          <div class="form-check-inline">
            ...
            ><label class="form-check-label" for="gender2">女性</lable>
          </div>
          <div class="form-group">
            ...
            <select class="form-control" id="age" name="age">
              ...
              <option value="1"
                <?php if(isset($_POST['age']) && $_POST['age'] === '1' ) { echo 'selected'; } ?>
              >19歳以下</option>
              <option value="2"
                <?php if(isset($_POST['age']) && $_POST['age'] === '2' ) { echo 'selected'; } ?>
              >20歳～29歳</option>
              <option value="3"
                <?php if(isset($_POST['age']) && $_POST['age'] === '3' ) { echo 'selected'; } ?>
              >30歳～39歳</option>
              <option value="4"
                <?php if(isset($_POST['age']) && $_POST['age'] === '4' ) { echo 'selected'; } ?>
              >40歳～49歳</option>
              <option value="5"
                <?php if(isset($_POST['age']) && $_POST['age'] === '5' ) { echo 'selected'; } ?>
              >50歳～59歳</option>
              <option value="6"
                <?php if(isset($_POST['age']) && $_POST['age'] === '6' ) { echo 'selected'; } ?>
              >60歳～</option>
            </select>
          </div>
          <div class="form-group">
          ...
          <div class="form-check">
            ...
            <label class="form-check-label">注意事項にチェックする</label>
          </div>
